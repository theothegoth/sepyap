  ...
  return (
    <>
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors">
        ...
        {/* Left: Cart Builder */}
        <div className="card">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">Alışveriş Listeniz</h2>
          <div className="mb-4">
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
              Ürün adıyla ekleyin veya <Link href="/search" className="text-blue-600 dark:text-blue-400 hover:underline font-medium">ürün ara</Link>
            </p>
          ...
          <div className="mb-4 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg border border-gray-200 dark:border-gray-600">
            <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-3">Markaya Göre Filtrele</h3>
          ...
          <ul className="space-y-2">
            ...
            {cart.length === 0 && <p className="text-gray-400 dark:text-gray-500 italic text-center py-4">Sepet boş.</p>}
          </ul>
        ...
        <div className="card" aria-label="En Ucuz Seçenek">
          <h2 className="text-2xl font-semibold mb-4 text-gray-900 dark:text-gray-100">En Ucuz Seçenek</h2>
          ...
          {result ? (
                  ...
                  <div key={idx} className="border border-gray-200 dark:border-gray-600 rounded-lg p-4 bg-gray-50 dark:bg-gray-700/50">
                    ...
                    <div className="mt-3 pt-3 border-t border-gray-300 dark:border-gray-600">
                      <div className="flex justify-between text-lg font-bold mb-2">
                        <span className="text-gray-900 dark:text-gray-100">Ürünler Toplamı:</span>
            ...
            <p className="text-gray-500 dark:text-gray-400 text-center py-8">Sepetinizi oluşturun ve optimize edin.</p>
          )}
        </div>
      </div>
      ...
      {isAdmin && (
      <section className="mt-12 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" aria-label="Son Taranan Ürünler">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-700 dark:text-gray-300">Son Taranan Ürünler (DB Kontrolü)</h2>
          <button onClick={fetchDebug} className="text-sm text-blue-600 dark:text-blue-400 hover:underline transition-colors" aria-label="Yenile">Yenile</button>
        </div>
        <div className="overflow-x-auto card">
          <table className="min-w-full text-sm text-left" role="table" aria-label="Son Taranan Ürünler">
            <thead className="bg-gray-100 dark:bg-gray-700">
              <tr>
                <th className="p-2 text-gray-700 dark:text-gray-300">Son Görüldü</th>
                <th className="p-2 text-gray-700 dark:text-gray-300">Son Güncellendi</th>
